    ...
    17: function (e, t, n) {
      ...
      Object(a.a)({}),
        o()(document).ready(function () {
          Object(g.isRTL)() && o()("html").attr("dir", "rtl").addClass("rtl");
          var e = o()("body"),
            t = o()(".js-header"),
            n = o()(".js-open-menu"),
            a = o()(".js-close-menu"),
          ...
          function A() {
            t.removeClass("submenu-is-active"),
              ...
              h.removeClass("opened").addClass("closed");
          }
          function L() {
          ...
          n.click(function () {
            ...
            i.click(function () {
              (S = !S)
                ? (t.addClass("submenu-is-active"),
                  i.addClass("active"),
                  h.removeClass("closed").addClass("opened"))
                : A();
            }),
            v.click(function () {
              j.addClass("opened"),
                ...
                if (e.length > 0) {
                  for (var n = 0, a = e.length; n < a; n++)
                    t += '\n          <article class="m-result">            <a href="'
                      ...
                      .concat(
                        Object(g.formatDate)(e[n].published_at),
                        "</span>            </a>          </article>"
                      );
                  C.hide(), w.html(t), w.show();
                } else w.html(""), w.hide(), C.show();
              } else w.html(""), w.hide(), C.hide();
            }),
            y.change(function () {
              y.is(":checked")
            ...
            O
              ? (o()("html").attr("data-theme", O),
                "dark" === O && y.attr("checked", !0))
          ...
          var M,
            ...
            T,
            I,
            F = document.querySelector(".js-header");
          F &&
            new r.a(F, { tolerance: { down: 10, up: 20 }, offset: 15 }).init();
          f.length > 0 &&
            (f.on("init", function () {
            ...
            "undefined" != typeof disableFadeAnimation && disableFadeAnimation
              ...
              : m.a.init({ once: !0, startEvent: "DOMContentLoaded" }),
            c()(".lozad", {
              loaded: function (e) {
            ...
            Object(u.a)(".js-article-card-title", 100),
            Object(u.a)(".js-article-card-title-no-image", 250),
            "undefined" != typeof ghostSearchApiKey
              ? ((M = ghostHost),
                (D = ghostSearchApiKey),
                (x = new GhostContentAPI({ url: M, key: D, version: "v2" })),
                (T = []),
                (I = {
                  shouldSort: !0,
                  threshold: 0,
                ...
                x.posts
                  .browse({
                    limit: "all",
                    fields:
                      "id, title, url, published_at, custom_excerpt, html",
                  })
                  .then(function (e) {
                    for (var t = 0, n = e.length; t < n; t++) T.push(e[t]);
                    _ = new p.a(T, I);
                  })
                  .catch(function (e) {
                    console.log(e);
